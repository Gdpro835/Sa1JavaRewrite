...
class RollPlatformSpeedB extends GimmickObject {
   ...
   public static final int DEGREE_VELOCITY = 102;
   ...
   protected RollPlatformSpeedB(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   public static void staticLogic() {
      degree = GameTime.advance(RollPlatformSpeedB.class, "degree", degree, 102);
      degree = GameTime.wrap(RollPlatformSpeedB.class, "degree", degree, 23040);
   }
   ...
   public void draw(MFGraphics var1) {
      if (StageManager.getCurrentZoneId() == 6 || StageManager.getCurrentZoneId() == 4) {
         ...
         int var2 = this.centerY;
         this.drawInMap(var1, var4, 0, 0, 16, 16, 0, var3, var2, 3);
         var4 = rolllinkImage;
         var2 = this.ring1PosX;
         var3 = this.ring1PosY;
         this.drawInMap(var1, var4, 16, 0, 16, 16, 0, var2, var3, 3);
         var4 = rolllinkImage;
         var3 = this.ring2PosX;
         var2 = this.ring2PosY;
   ...
   public void logic() {
      ...
      int var1 = degree;
      int var2 = this.iLeft * 23040 / 16;
      int var4 = this.posX;
      int var3 = this.posY;
      var2 = (var1 + var2 + 23040) % 23040;
      var1 = var2;
      if (!this.direction) {
         var1 = -var2;
